...
ActiveRecord::Schema.define(version: 20_120_610_091_944) do
  ...
  add_index 'wice_grid_serialized_queries', %w(grid_name id), name: 'index_wice_grid_serialized_queries_on_grid_name_and_id'
